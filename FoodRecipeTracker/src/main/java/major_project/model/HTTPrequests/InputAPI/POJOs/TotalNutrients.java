...
public class TotalNutrients {
    ...
    private ArrayList<GeneralNutrients> list;

    public TotalNutrients(GeneralNutrients eNERC_KCAL, GeneralNutrients fAT, GeneralNutrients fASAT,
        ...
        this.list.add(eNERC_KCAL);
        this.list.add(fAT);
        this.list.add(fASAT);
        this.list.add(fAMS);
        this.list.add(fAPU);
        this.list.add(cHOCDF);
        this.list.add(fIBTG);
        this.list.add(sUGAR);
        this.list.add(pROCNT);
        this.list.add(cHOLE);
        this.list.add(nA);
        this.list.add(mG);
        this.list.add(k);
        ...
        this.list.add(zN);
        this.list.add(p);
        this.list.add(vITA_RAE);
        this.list.add(vITC);
        this.list.add(tHIA);
        this.list.add(rIBF);
        this.list.add(nIA);
        this.list.add(vITB6A);
        this.list.add(fOLDFE);
        this.list.add(fOLFD);
        this.list.add(fOLAC);
        this.list.add(vITB12);
        this.list.add(vITD);
        this.list.add(tOCPHA);
        this.list.add(vITK1);
        this.list.add(wATER);
    }
